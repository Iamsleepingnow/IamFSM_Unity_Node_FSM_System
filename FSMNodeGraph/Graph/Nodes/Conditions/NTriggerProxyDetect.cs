...
namespace FSMGraph
{
    [System.Serializable, NodeMenuItem("条件 Conditions/触发检测(远程) Trigger Detect Proxy")]
    public class NTriggerProxyDetect : BaseNode
    {
        ...
        public override string name => "触发检测(远程) Trigger Detect Proxy";
