...
namespace GraphProcessor
{
	...
	public abstract class BaseNode
	{
		...
		public string NodeCustomName => nodeCustomName;
		...
		public bool UpdatePortsForFieldLocal(string fieldName, bool sendPortUpdatedEvent = true)
		{
			...
			void AddPortData(PortData portData)
			{
				...
				else
				{
					...
					// RelayNode 的端口类型动态变化，不适用此检测
					if (port.owner is not RelayNode
					    && !BaseGraph.TypesAreConnectable(port.portData.displayType, portData.displayType))
					{
